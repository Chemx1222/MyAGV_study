...
while True:
    ...
    # 컨투어 내부를 흰색으로 채우기
    cv2.fillPoly(combined, contours, (255, 255, 255))

    # 컨투어 외부를 검은색으로 채우기
    cv2.drawContours(combined, contours, -1, (0, 0, 0), thickness=cv2.FILLED)

    # 컨투어 그리기
    cv2.drawContours(combined, contours, -1, (255, 0, 255), thickness=2)
